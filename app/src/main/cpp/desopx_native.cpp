...
#include <iostream>
#include <string>
#include "desopx_native.h"
#include "desopx_app_list.h"
#include <android/log.h>

using namespace std;

extern "C" jboolean Java_cn_yue_test_utils_DesopxNative_auth(JNIEnv *env, jclass type) {
    return checkXposedResult(env);
}

static const char *findClassName = "cn/yue/test/utils/DesopxNative";
