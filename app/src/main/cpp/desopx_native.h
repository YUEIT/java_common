...
#include <jni.h>
#include <string>
#ifndef KOTLIN_COMMON_DESOPX_NATIVE_H
#define KOTLIN_COMMON_DESOPX_NATIVE_H
...
JNICALL
Java_cn_yue_test_utils_DesopxNative_auth(JNIEnv *env, jclass type);

#ifdef __cplusplus
}
#endif

#endif //KOTLIN_COMMON_DESOPX_NATIVE_H
